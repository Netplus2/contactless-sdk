package com.netpluspay.contactless.sdk.ui.dialog;
...
import com.netpluspay.contactless.sdk.utils.AppUtilsKt;
import com.netpluspay.contactless.sdk.utils.TripleDES;
...
public class PasswordDialog {
    ...
    public PasswordDialog(Activity context, String pan, String key, Listener pinListener) {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            pinListener.onConfirm(encodePinBlock(etPin.getText().toString(), pan, key));
            dialog.cancel();
        });
    ...
    private static String encodePinBlock(String pin, String pan, String key) {
        ...
        String pinblock = AppUtilsKt.xorHex(pinP, cardNum);
